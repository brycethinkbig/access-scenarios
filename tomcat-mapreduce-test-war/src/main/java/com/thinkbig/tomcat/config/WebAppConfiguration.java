...
public class WebAppConfiguration
{
	...
	@Bean
	public JobServlet jobServlet(JobLauncherService<TomcatJobConfiguration> jobService)
	{
		return new JobServlet(jobService);
	}
	
	@Bean
	public JobLauncherService<TomcatJobConfiguration> tomcatJobLauncherService()
	{
		return new DefaultJobLauncherService();
		//return new ProcessForkJobLauncherService();
	}
